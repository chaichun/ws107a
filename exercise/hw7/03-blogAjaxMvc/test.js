...
describe('blogAjax', function () {
  ...
  describe('puppeteer', function () {
    ...
    it('fill {title:"abc", body:"abc"}', async function () {
      await page.focus('#title')
    ...
    it('should see <p>You have <strong>2</strong> posts!</p>', async function () {
      let html = await page.content()
      ok(html.indexOf('<p>You have <strong>2</strong> posts!</p>') >= 0)
    })
    it('should see <p>You have <strong>1</strong> posts!</p>', async function () {
